import"./assets/themeBackground-b929f422.js";import{a as D,i as m}from"./assets/vendor-96017409.js";const C="https://your-energy.b.goit.study/api",_=12,B=10,u=D.create({baseURL:C,params:{}}),I=async(e,t=1)=>(await u.get("/filters",{params:{filter:e,page:t,limit:_}})).data,R=async(e=1)=>(await u.get("/filters",{params:{filter:"Muscles",page:e,limit:_}})).data,O=async()=>(await u.get("/quote")).data,N=async({bodypart:e,muscles:t,equipment:c,search:s},n=1)=>{const a=s&&!e&&!t&&!c?"":s;return(await u.get("/exercises",{params:{bodypart:e||"",muscles:t||"",equipment:c||"",keyword:a||"",page:n,limit:B}})).data},A=async e=>(await u.get(`/exercises/${e}`)).data,U=async(e,t)=>(await u.patch(`/exercises/${e}/rating`,t)).data;function b(e){return e.map(({imgURL:t,filter:c,name:s})=>`<li class="card-exercises" data-body-exercise='${s}'>
