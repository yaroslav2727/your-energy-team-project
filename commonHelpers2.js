import"./assets/themeBackground-e2f72e63.js";import{a as O,i as f}from"./assets/vendor-96017409.js";const U="https://your-energy.b.goit.study/api",S=12,N=10,m=O.create({baseURL:U,params:{}}),A=async(e,t=1)=>(await m.get("/filters",{params:{filter:e,page:t,limit:S}})).data,H=async(e=1)=>(await m.get("/filters",{params:{filter:"Muscles",page:e,limit:S}})).data,j=async()=>(await m.get("/quote")).data,F=async({bodypart:e,muscles:t,equipment:a,search:s},n=1)=>{const c=s&&!e&&!t&&!a?"":s;return(await m.get("/exercises",{params:{bodypart:e||"",muscles:t||"",equipment:a||"",keyword:c||"",page:n,limit:N}})).data},Q=async e=>(await m.get(`/exercises/${e}`)).data,P=async(e,t)=>(await m.patch(`/exercises/${e}/rating`,t)).data;function k(e){return e.map(({imgURL:t,filter:a,name:s})=>`<li class="card-exercises" data-body-exercise='${s}'>
