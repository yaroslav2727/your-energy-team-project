import"./assets/themeBackground-3205a5fa.js";import{a as O,l as U,i as u}from"./assets/vendor-57c75b59.js";const N="https://your-energy.b.goit.study/api",S=12,j=10,p=O.create({baseURL:N,params:{}}),A=async(e,t=1)=>(await p.get("/filters",{params:{filter:e,page:t,limit:S}})).data,H=async(e=1)=>(await p.get("/filters",{params:{filter:"Muscles",page:e,limit:S}})).data,F=async()=>(await p.get("/quote")).data,Q=async({bodypart:e,muscles:t,equipment:a,search:s},n=1)=>{const c=s&&!e&&!t&&!a?"":s;return(await p.get("/exercises",{params:{bodypart:e||"",muscles:t||"",equipment:a||"",keyword:c||"",page:n,limit:j}})).data},P=async e=>(await p.get(`/exercises/${e}`)).data,K=async(e,t)=>(await p.patch(`/exercises/${e}/rating`,t)).data,W="/your-energy-team-project/assets/no-image-3f568e29.jpg";function k(e){return e.map(({imgURL:t,filter:a,name:s})=>`<li class="card-exercises" data-body-exercise='${s}'>
