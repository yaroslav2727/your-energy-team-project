import"./assets/activePageHeader-1a989ebf.js";import{a as m}from"./assets/vendor-a61d8330.js";const x="https://your-energy.b.goit.study/api",u=12,f=10,o=m.create({baseURL:x,params:{}}),v=async(e,s=1)=>(await o.get("/filters",{params:{filter:e,page:s,limit:u}})).data,h=async(e=1)=>(await o.get("/filters",{params:{filter:"Muscles",page:e,limit:u}})).data,y=async({bodypart:e,muscles:s,equipment:r,search:t},a=1)=>{const n=t&&!e&&!s&&!r?"":t;return(await o.get("/exercises",{params:{bodypart:e||"",muscles:s||"",equipment:r||"",keyword:n||"",page:a,limit:f}})).data};function p(e){return e.map(({imgURL:s,filter:r,name:t})=>`<li class="card-exercises" data-body-exercise='${t}'>
