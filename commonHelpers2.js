import"./assets/activePageHeader-78d48107.js";import{a as L,i as l}from"./assets/vendor-96017409.js";const w="https://your-energy.b.goit.study/api",h=12,E=10,d=L.create({baseURL:w,params:{}}),$=async(e,s=1)=>(await d.get("/filters",{params:{filter:e,page:s,limit:h}})).data,k=async(e=1)=>(await d.get("/filters",{params:{filter:"Muscles",page:e,limit:h}})).data,S=async({bodypart:e,muscles:s,equipment:n,search:t},c=1)=>{const a=t&&!e&&!s&&!n?"":t;return(await d.get("/exercises",{params:{bodypart:e||"",muscles:s||"",equipment:n||"",keyword:a||"",page:c,limit:E}})).data},M=async e=>(await d.get(`/exercises/${e}`)).data,T=async(e,s)=>(await d.patch(`/exercises/${e}/rating`,s)).data;function v(e){return e.map(({imgURL:s,filter:n,name:t})=>`<li class="card-exercises" data-body-exercise='${t}'>
...
</div >`}function W(e){const s=e.target;if(!s.classList.contains("js-excercise-button"))return;const t=s.closest(".exercises-item").dataset.exerciseId;console.log(t),M(t).then(c=>{console.log(c);const a=K(c);P.innerHTML=a}),_.classList.remove("is_hidden")}function X(){_.classList.add("is_hidden"),console.log("close modal")}
